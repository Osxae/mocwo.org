...
const Navigation = () => {
  ...
  const navItems = [
    ...
    // ✅ PRAYER AI PAGE
    { name: "Prayer", path: "/prayer-ai" },
  ];

  const isActive = (path: string) => location.pathname === path;

  /**
   * 🚨 Hide navbar ONLY on the main FHC landing page
   * This keeps navbar AVAILABLE on /prayer-ai
   */
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button
              variant="outline"
              size="sm"
              className="ml-4 border-blue-500 text-blue-600 hover:bg-blue-600 hover:text-white"
            >
              Admin
            </Button>
          </div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="px-4 pt-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full border-blue-500 text-blue-600 hover:bg-blue-600 hover:text-white"
                >
                  Login
                </Button>
              </div>
