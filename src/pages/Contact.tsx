...
const Contact = () => {
  ...
  return (
   ...
   {/* ✅ HERO WITH HOMEPAGE BLUE GRADIENT */}
<section
...
>
  <div className="absolute inset-0 bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70" />
  ...
  <div className="container mx-auto px-4 relative z-10 text-center text-white">
    ...
    <p className="text-xl opacity-90 mb-8">
              ...
              return (
                <Card key={index} className="border-0 shadow-card hover:shadow-divine transition-all duration-300 hover:scale-105 text-center">
                  <CardContent className="p-8">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70 flex items-center justify-center mx-auto mb-6">
                      <Icon className="w-8 h-8 text-primary-foreground" />
                    </div>
                    <h3 className="text-xl font-bold mb-2 ">{method.title}</h3>
                    <p className="text-muted-foreground mb-3 ">{method.description}</p>
                    <p className="text-secondary font-semibold mb-4 ">{method.details}</p>
                    <Button className="w-full bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70">{method.action}</Button>
                  </CardContent>
                </Card>
              );
            })}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <Card className="border-0 shadow-divine">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70 text-primary-foreground">
                      Send Message
                    </Button>
                  </form>
                </CardContent>
            ...
            <div className="space-y-6">
              ...
              {locations.map((location, index) => (
                <Card key={index} className={`border-0 shadow-card ${location.isMain ? 'ring-2 ring-secondary' : ''}`}>
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-xl font-bold">{location.name}</h3>
                      {location.isMain && (
                        <span className="bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70 text-primary-foreground text-xs px-2 py-1 rounded-full">
                          Main Campus
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex space-x-2 mt-4">
                      ...
                      <Button size="sm" className="flex-1 bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70">
                        Call Location
                      </Button>
                    </div>
                  </CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600/70">
        <div className="container mx-auto px-4">
