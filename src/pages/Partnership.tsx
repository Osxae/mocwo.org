...
>
  ...
  <div className="container mx-auto px-4 relative z-10 text-center text-white">
    <h1 className="text-5xl md:text-6xl font-bold mb-6">Kingdom Partnership</h1>
    <p className="text-xl opacity-90 mb-8">
      Partner with us in advancing God's kingdom around the world
    </p>
  </div>
</section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {/* ✅ CTA BUTTON HOMEPAGE BLUE GRADIENT */}
<Button size="lg" className="bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600 text-white">
            ...
            <Card className="border-0 shadow-divine">
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600 ">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index}>
                  <Link
                    to={item.link}
                    className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-blue-950 via-blue-800 to-cyan-600 hover:scale-105 hover:underline transition-transform duration-300"
                  >
                    {item.name}
                  </Link>
                </li>
