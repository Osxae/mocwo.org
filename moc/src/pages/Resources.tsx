...
const Resources = () => {
  const resourceCategories = [
    { title: "Sermons", description: "Life-changing messages from our weekly services", icon: Play, gradient: "from-primary to-primary-glow", link: "/resources/sermons" },
    { title: "Books", description: "Spiritual literature for growth and inspiration", icon: Book, gradient: "from-secondary to-yellow-400", link: "/resources/books" },
    { title: "Podcasts", description: "On-the-go inspiration for your daily journey", icon: Headphones, gradient: "from-accent to-cyan-400", link: "/resources/podcasts" },
    { title: "Downloads", description: "Study guides, worksheets, and digital content", icon: Download, gradient: "from-purple-500 to-pink-500", link: "/resources/downloads" }
  ];
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-primary-foreground">
            ...
            <p className="text-xl opacity-90 mb-8">Equip yourself with powerful spiritual tools for growth and transformation</p>
            ...
            {featuredSermons.map((sermon, index) => (
              <Card key={index} className="border-0 shadow-card hover:shadow-divine transition-all duration-300 hover:scale-105">
                <CardContent className="p-0">
                  <div className="aspect-video bg-gradient-kingdom flex items-center justify-center text-4xl">{sermon.image}</div>
                  <div className="p-6">
